...
In particolare negli ultimi anni si \`{e} prestata molta attenzione nel cercare di ridurre la dose di radiazioni a cui \`{e} sottoposto il paziente, ma questo genera un aumento del rumore "quantico" dell' immagine dovuto all' interazione dei fotoni con i recettori del macchinario.\\
